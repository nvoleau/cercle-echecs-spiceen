import { Calendar, Clock, MapPin, Trophy, Zap, GraduationCap, Info } from 'lucide-react'
...
export default function EventCard({ event }: EventCardProps) {
  return (
    <article className="bg-white rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition-shadow p-6 flex flex-col gap-4">
